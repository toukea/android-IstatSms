...
public final class SmsSender {
	...
	public SmsSender setDeliveryConfig(HandlerConfig deliveryConfig) {
		this.deliveryConfig = deliveryConfig;
		return this;
	}

	public SmsSender setDeliveryConfig(Intent intent, int requestCode, int flag) {
		this.deliveryConfig = new HandlerConfig(intent, requestCode, flag);
		return this;
	}

	public SmsSender setSendConfig(HandlerConfig sendConfig) {
		this.sendConfig = sendConfig;
		return this;
	}

	public SmsSender setSendConfig(Intent intent, int requestCode, int flag) {
