...
public final class SmsQL {
	...
	protected void sample(Context context) {
	SmsQL ql=new SmsQL(context);
	ql.selectSms().whereAdressEqual("40101383").execute();
	}
	// ------------
	/*
	 * public boolean smsExist(String id){ return SmsQuery.smsIdExist(context,
	 * id); }
	 */
}
